...
client.on("guildMemberAdd", member => {
  member.roles.add('803702470462799922'); // UNREGİSTER ROLÜNÜN İDSİNİ GİRİN
});
//-----------------------GİRENE-ROL-VERME----------------------\\     STG
...
client.on("guildMemberAdd", member => {  
    const kanal = member.guild.channels.cache.find(r => r.id === "798856002467790863");
    const register = "<@&798856002392948790>"
