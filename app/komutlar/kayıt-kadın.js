...
exports.run = async (client, message, args) => {
 ...
 if(!['803702370197438545', '803702370197438545', 'EĞER KOYMAK İSTEMİYORSAN TIRNAKLARI SİL'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) return message.reply(`Bu Komut İçin Yetkiniz Bulunmamaktadır.`) 
  
let tag = "々"
const kayıtlı = message.guild.roles.cache.find(r => r.id === '803702370197438545')
...
.setColor('GREEN')
client.channels.cache.get('798856002467790863').send(embed)
