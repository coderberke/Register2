...
exports.run = async (client, message, args) => {
    ...
    if(!message.member.roles.cache.some(r => ["803702224525852732", "803702224525852732"].includes(r.id)) && (!message.member.hasPermission("ADMINISTRATOR")))
...
.setFooter(`あ Alesta #SİLBAŞTAN`) // evet bilerek kaldırmadım ayriyetten sıfırdan yazdım :)
...
.setFooter(`Eternal #Diriliş`) // evet bilerek kaldırmadım ayriyetten sıfırdan yazdım :)
...
exports.conf = {
    enabled: true,
    guildOnly: true,
    aliases: ["say", "kayıtlar", "kayıt-kontrol"],
    permLvl: 0,
}
